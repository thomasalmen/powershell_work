...
New-PSRoleCapabilityFile -Path "$env:ProgramFiles\WindowsPowerShell\Modules\JEA_Katalogtjanst\RoleCapabilities\JEA_Katalogtjanst.psrc" @MaintenanceRoleCapabilityCreationParams
...
if(-not (Test-Path “$env:ProgramFiles\WindowsPowerShell\Modules\JEA_Katalogtjanst" ))
{
